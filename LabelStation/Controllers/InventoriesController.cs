    ...
    public class InventoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Inventory != null ? 
                          ...
                          Problem("Entity set 'InventoryContext.Inventory'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,EmployeeName,PrintNumber")] Inventory inventory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmployeeName,PrintNumber")] Inventory inventory)
        {
            if (id != inventory.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'InventoryContext.Inventory'  is null.");
            }
            var inventory = await _context.Inventory.FindAsync(id);
            if (inventory != null)
            {
